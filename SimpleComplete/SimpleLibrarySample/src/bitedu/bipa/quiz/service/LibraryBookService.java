...
import bitedu.bipa.quiz.dao.*;
import bitedu.bipa.quiz.util.*;
...
public class LibraryBookService {
	...
	public boolean putIntoDB_Book(ArrayList<BookUseStatusVO> bookList) {
		
		return dao.insertBookList(bookList);
	}
	
	public void putIntoDB_User(ArrayList<UserBookStatusVO> user) {
